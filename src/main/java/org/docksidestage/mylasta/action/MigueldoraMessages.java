...
import org.docksidestage.mylasta.action.MigueldoraLabels;
 ...
 * @author FreeGen
 */
public class MigueldoraMessages extends MigueldoraLabels {
     ...
     * @return this. (NotNull)
     */
    public MigueldoraMessages addErrorsHeader(String property) {
     ...
     * @return this. (NotNull)
     */
    public MigueldoraMessages addErrorsFooter(String property) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public MigueldoraMessages addErrorsPrefix(String property) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public MigueldoraMessages addErrorsSuffix(String property) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public MigueldoraMessages addConstraintsAssertFalseMessage(String property) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public MigueldoraMessages addConstraintsAssertTrueMessage(String property) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public MigueldoraMessages addConstraintsDecimalMaxMessage(String property, String value) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public MigueldoraMessages addConstraintsDecimalMinMessage(String property, String value) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public MigueldoraMessages addConstraintsDigitsMessage(String property, String integer, String fraction) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public MigueldoraMessages addConstraintsFutureMessage(String property) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public MigueldoraMessages addConstraintsMaxMessage(String property, String value) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public MigueldoraMessages addConstraintsMinMessage(String property, String value) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public MigueldoraMessages addConstraintsNotNullMessage(String property) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public MigueldoraMessages addConstraintsNullMessage(String property) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public MigueldoraMessages addConstraintsPastMessage(String property) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public MigueldoraMessages addConstraintsPatternMessage(String property, String regexp) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public MigueldoraMessages addConstraintsSizeMessage(String property, String min, String max) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public MigueldoraMessages addConstraintsCreditCardNumberMessage(String property) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public MigueldoraMessages addConstraintsEanMessage(String property, String type) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public MigueldoraMessages addConstraintsEmailMessage(String property) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public MigueldoraMessages addConstraintsLengthMessage(String property, String min, String max) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public MigueldoraMessages addConstraintsLuhnCheckMessage(String property, String value) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public MigueldoraMessages addConstraintsMod10CheckMessage(String property, String value) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public MigueldoraMessages addConstraintsMod11CheckMessage(String property, String value) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public MigueldoraMessages addConstraintsModCheckMessage(String property, String value, String modType) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public MigueldoraMessages addConstraintsNotBlankMessage(String property) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public MigueldoraMessages addConstraintsNotEmptyMessage(String property) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public MigueldoraMessages addConstraintsParametersScriptAssertMessage(String property, String script) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public MigueldoraMessages addConstraintsRangeMessage(String property, String min, String max) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public MigueldoraMessages addConstraintsSafeHtmlMessage(String property) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public MigueldoraMessages addConstraintsScriptAssertMessage(String property, String script) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public MigueldoraMessages addConstraintsUrlMessage(String property) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public MigueldoraMessages addConstraintsRequiredMessage(String property) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public MigueldoraMessages addConstraintsTypeAnyMessage(String property, String propertyType) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public MigueldoraMessages addErrorsLoginFailure(String property) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public MigueldoraMessages addErrorsAppIllegalTransition(String property) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public MigueldoraMessages addErrorsAppDbAlreadyDeleted(String property) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public MigueldoraMessages addErrorsAppDbAlreadyUpdated(String property) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public MigueldoraMessages addErrorsAppDbAlreadyExists(String property) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public MigueldoraMessages addErrorsAppDoubleSubmitRequest(String property) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public MigueldoraMessages addErrorsSignupAccountAlreadyExists(String property) {
        assertPropertyNotNull(property);
