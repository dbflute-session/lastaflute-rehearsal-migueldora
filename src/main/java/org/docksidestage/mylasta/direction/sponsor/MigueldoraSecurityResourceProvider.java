 ...
 * @author jflute
 */
public class MigueldoraSecurityResourceProvider implements SecurityResourceProvider {
    ...
    public MigueldoraSecurityResourceProvider(InvertibleCryptographer primaryInvertibleCryptographer,
