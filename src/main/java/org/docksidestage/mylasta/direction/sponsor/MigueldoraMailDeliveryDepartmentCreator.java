 ...
 * @author jflute
 */
public class MigueldoraMailDeliveryDepartmentCreator {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public MigueldoraMailDeliveryDepartmentCreator(MigueldoraConfig migueldoraConfig) {
    ...
    protected SMailPostalParkingLot createPostalParkingLot() {
        ...
        final String hostAndPort = migueldoraConfig.getMailSmtpServerMainHostAndPort();
        ...
        motorbike.registerReturnPath(migueldoraConfig.getMailReturnPath());
    ...
    protected SMailPostalPersonnel createPostalPersonnel() {
        ...
        return migueldoraConfig.isMailSendMock() ? personnel.asTraining() : personnel;
    }

    protected SMailDogmaticPostalPersonnel createDogmaticPostalPersonnel() { // #ext_point e.g. locale, database
        final String testPrefix = migueldoraConfig.getMailSubjectTestPrefix();
