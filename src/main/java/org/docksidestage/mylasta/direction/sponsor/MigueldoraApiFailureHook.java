 ...
 * @author jflute
 */
public class MigueldoraApiFailureHook implements ApiFailureHook { // #change_it for handling API failure
    ...
    public static class TooSimpleFailureBean {
        ...
        public final String notice = "[Attension] tentative JSON so you should change it: " + MigueldoraApiFailureHook.class;
