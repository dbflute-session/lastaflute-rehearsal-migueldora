 ...
 * @author jflute
 */
public class MigueldoraLoginAssist extends TypicalLoginAssist<Integer, MigueldoraUserBean, Member> // #change_it also UserBean
    ...
    //                                                                       =============
    @Override
    protected MigueldoraUserBean createUserBean(Member userEntity) {
        return new MigueldoraUserBean(userEntity);
    }

    @Override
    protected OptionalThing<String> getCookieRememberMeKey() {
        return OptionalThing.of(migueldoraConfig.getCookieRememberMeMigueldoraKey());
    }
    ...
    @Override
    protected void saveLoginHistory(Member member, MigueldoraUserBean userBean, LoginSpecifiedOption option) {
        asyncManager.async(() -> {
    ...
    //                                                                      ==============
    @Override
    protected Class<MigueldoraUserBean> getUserBeanType() {
        return MigueldoraUserBean.class;
    }
