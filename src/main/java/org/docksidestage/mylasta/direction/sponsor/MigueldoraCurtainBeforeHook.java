 ...
 * @author jflute
 */
public class MigueldoraCurtainBeforeHook implements CurtainBeforeHook {
    ...
    protected DfFinalTimeZoneProvider createFinalTimeZoneProvider() {
        return new DfFinalTimeZoneProvider() {
            protected final TimeZone provided = MigueldoraUserTimeZoneProcessProvider.centralTimeZone;
